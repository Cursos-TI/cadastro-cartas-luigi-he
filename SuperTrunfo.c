...
int main() {
    ...
    float area, area2, pib, pib2, densidade1, densidade2, pibpercapita1, pibpercapita2;
...
densidade1 = populaçao / area;
densidade2 = populaçao2 / area2;
pibpercapita1 = pib / populaçao;
...
printf("Carta 1\nEstado: %c\nCódigo: %s\nNome da Cidade: %s\nPopulação: %i\nÁrea: %.2fkm²\nPIB: %.2f\nNúmero de pontos turísticos: %i\nDensidade populacional: %.2f\n PIB per capita: %.2f\n\n", estado, CodigoEstado, NomeDaCidade, populaçao, area, pib, PontosTuristicos, densidade1, pibpercapita1);
printf("Carta 2\nEstado: %c\nCódigo: %s\nNome da Cidade: %s\nPopulação: %i\nÁrea: %.2fkm²\nPIB: %.2f\nNúmero de pontos turísticos: %i\nDensidade populacional: %.2f\n PIB per capita: %.2f\n", estado2, CodigoEstado2, NomeDaCidade2, populaçao2, area2, pib2, PontosTuristicos2, densidade2, pibpercapita2);
